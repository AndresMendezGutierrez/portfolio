...
export const ui = {
  en: {
    ...
    contact_terms: "I agree with the terms and conditions",
  ...
  es: {
    ...
    contact_terms: "Acepto los términos y condiciones",
  ...
  de: {
    ...
    contact_terms: "Ich stimme den Allgemeinen Geschäftsbedingungen zu",
